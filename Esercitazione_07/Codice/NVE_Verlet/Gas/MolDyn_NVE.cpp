...
int main(){
  ...
  ofstream Term;
  Term.open("../../../Risultati/NVE_Verlet/Gas/output_restart.dat",ios::app);

  cout<<endl<<endl<<"Thermalization of the system"<<endl;
   //termalizzazione del sistema con metodo di partire da una temperatura più bassa (con il metodo Termalizzazione())
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    Epot.open("../../../Risultati/NVE_Verlet/Gas/output.epot.0",ios::app);
    Pres.open("../../../Risultati/NVE_Verlet/Gas/output.pres.0",ios::app);
    Gofr.open("../../../Risultati/NVE_Verlet/Gas/output.gofr.0",ios::app);
    Gave.open("../../../Risultati/NVE_Verlet/Gas/output.gave.0",ios::app);
    Temp.open("../../../Risultati/NVE_Verlet/Gas/output.temp.0",ios::app);
