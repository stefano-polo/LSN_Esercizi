...
int main(){
  ...
  ofstream Term;
  Term.open("../../../Risultati/NVE_Verlet/Solid/output_restart.dat",ios::app);
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    Epot.open("../../../Risultati/NVE_Verlet/Solid/output.epot.0",ios::app);
    Pres.open("../../../Risultati/NVE_Verlet/Solid/output.pres.0",ios::app);
    Gofr.open("../../../Risultati/NVE_Verlet/Solid/output.gofr.0",ios::app);
    Gave.open("../../../Risultati/NVE_Verlet/Solid/output.gave.0",ios::app);
    Temp.open("../../../Risultati/NVE_Verlet/Solid/output.temp.0",ios::app);
