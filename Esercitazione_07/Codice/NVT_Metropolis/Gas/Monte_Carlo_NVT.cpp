...
void Print_Istant(){  //stampa i valori istantanei di pressione, energia potenziale
    ofstream Epot, Pres;
    Epot.open("../../../Risultati/NVT_Metropolis/Gas/istant.epot.0",ios::app);
    Pres.open("../../../Risultati/NVT_Metropolis/Gas/istant.pres.0",ios::app);
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    Epot.open("../../../Risultati/NVT_Metropolis/Gas/output.epot.0",ios::app);
    Pres.open("../../../Risultati/NVT_Metropolis/Gas/output.pres.0",ios::app);
    Gofr.open("../../../Risultati/NVT_Metropolis/Gas/output.gofr.0",ios::app);
    Gave.open("../../../Risultati/NVT_Metropolis/Gas/output.gave.0",ios::app);
