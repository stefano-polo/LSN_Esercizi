...
void Energy(int iblk) {
	...
	Ene.open("../../Risultati/Metropolis/output.ene.0",ios::app);
	...
	energy = glob_av[iu]/(double)iblk;
  	...
  	Ene.close();
	if(iblk == nblk){
   	 	ResultsU.open("../../Risultati/Metropolis/ene.result.0",ios::app);  //Stampo i valori piu precisi per il grafico in funzione della temperatura
...
void Heath(int iblk) {
	...
	Heat.open("../../Risultati/Metropolis/output.heat.0",ios::app);
  	...
  	Heat.close();
	if(iblk == nblk){
   	 	ResultsC.open("../../Risultati/Metropolis/heat.result.0",ios::app);  //Stampo i valori piu precisi per il grafico in funzione della temperatura
...
void Mag(int iblk){
	...
	Mag.open("../../Risultati/Metropolis/output.mag.0",ios::app);
	...
	Mag.close();
	if(iblk == nblk){
   	 	 ResultsM.open("../../Risultati/Metropolis/mag.result.0",ios::app);  //Stampo i valori piu precisi per il grafico in funzione della temperatura
...
void Chi(int iblk){
	...
	Chi.open("../../Risultati/Metropolis/output.chi.0",ios::app);
  	...
  	Chi.close();
	if(iblk == nblk){
   	 	 ResultsX.open("../../Risultati/Metropolis/chi.result.0",ios::app); //Stampo i valori piu precisi per il grafico in funzione della temperatura
