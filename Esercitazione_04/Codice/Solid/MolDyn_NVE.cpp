...
int main(){
  ...
  ofstream Term;
  Term.open("../../Risultati/Solid/output_restart.dat",ios::app);
...
void Print_Istant(){  //stampa i valori istantanei di pressione, energia potenziale
    ...
    Epot.open("../../Risultati/Solid/output_epot.dat",ios::app);
    Pres.open("../../Risultati/Solid/output_pres.dat",ios::app);
    Temp.open("../../Risultati/Solid/output_temp.dat",ios::app);
    Etot.open("../../Risultati/Solid/output_etot.dat",ios::app);
    Ekin.open("../../Risultati/Solid/output_ekin.dat",ios::app);
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    Epot.open("../../Risultati/Solid/ave_epot.out",ios::app);
    Pres.open("../../Risultati/Solid/ave_pres.out",ios::app);
    Gofr.open("output.gofr.0",ios::app);
    Gave.open("output.gave.0",ios::app);
    Temp.open("../../Risultati/Solid/ave_temp.out",ios::app);
    Ekin.open("../../Risultati/Solid/ave_ekin.out",ios::app);
    Etot.open("../../Risultati/Solid/ave_etot.out",ios::app);
