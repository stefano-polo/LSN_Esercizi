...
int main(){
  ...
  ofstream Term;
  Term.open("../../Risultati/Liquid/output_restart.dat",ios::app);
  ...
  for(int iblk=1; iblk <= nblk; ++iblk){ //Simulation
	   ...
	   Reset(iblk);   //Reset block averages
        ...
        if(istep%10 == 0){
          ...
          //Print_Istant(); SCOMMENTARE se si desiderano le grandezze istantanee
...
void Print_Istant(){  //stampa i valori istantanei di pressione, energia potenziale...
    ...
    Epot.open("../../Risultati/Liquid/output_epot.dat",ios::app);
    Pres.open("../../Risultati/liquid/output_pres.dat",ios::app);
    Temp.open("../../Risultati/Liquid/output_temp.dat",ios::app);
    Etot.open("../../Risultati/Liquid/output_etot.dat",ios::app);
    Ekin.open("../../Risultati/Liquid/output_ekin.dat",ios::app);
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    Epot.open("../../Risultati/Liquid/ave_epot.out",ios::app);
    Pres.open("../../Risultati/Liquid/ave_pres.out",ios::app);
    Gofr.open("output.gofr.0",ios::app);
    Gave.open("output.gave.0",ios::app);
    Temp.open("../../Risultati/Liquid/ave_temp.out",ios::app);
    Ekin.open("../../Risultati/Liquid/ave_ekin.out",ios::app);
    Etot.open("../../Risultati/Liquid/ave_etot.out",ios::app);
